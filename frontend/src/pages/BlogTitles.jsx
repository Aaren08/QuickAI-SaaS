...
const BlogTitles = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      setLoading(true);
      const prompt = `Generate a few blog titles for the keyword ${input} in the category ${selectedCategory}. Do not stop mid-sentence. Ensure the blog title has a clear conclusion.`;
  ...
  return (
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700">
      ...
      >
        ...
        <button
          disabled={loading}
          className="flex items-center justify-center gap-2 w-full mt-2 px-4 py-2 bg-gradient-to-r from-[#c341f6] to-[#8e37eb] text-white rounded-lg"
        >
          {loading ? (
